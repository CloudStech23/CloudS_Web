...
function Contact() {
  return (
    ...
    //            <h3><i title='Map' className='fa fa-map'></i></h3>
    ...
    //         <FadeOnScroll animation='up'>
    //            <h3><i title='Phone' className='fa fa-phone'></i></h3>
    ...
    //         <FadeOnScroll animation='up'>
    //            <h3><i title='email' className='fa fa-envelope'></i></h3>
    ...
    //          <p class="text-light text-muted mb-2  " style={{fontWeight:400}}>
    ...
    //             </div>
    //             <div className="col-12">
    //               <input className="my-btn  py-2 px-3 me-3" id="submitButton" type="submit" value='Send Message'   />
    //             </div>
    //           </div>
    //         </form>
    //         </FadeOnScroll>
    ...
    <section class="py-3 py-md-5">
      <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
          <div
            className=" col-12 col-lg-6 wow fadeIn leftside-design"
            data-wow-delay="0.1s"
          >
            <FadeOnScroll>
              <h1 className="display-6 fw-normal mb-2 text-light  ">
                Contact With Us Now!
              </h1>
              <p
                class="text-light text-muted mb-2  "
                style={{ fontWeight: 400 }}
              >
                Experience our proficiency! Learn why our clients are ecstatic
                to collaborate with us. Reach out to us to get started
              </p>
              <form>
                <div className="row g-3">
                  <div className="col-12">
                    <div className="form-floating">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="name" className="inp-field">
                  ...
                  <div className="col-12">
                    <div className="form-floating">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="email" className="inp-field">
                  ...
                  <div className="col-12">
                    <div className="form-floating">
                      <input
                        ...
                        placeholder="Subject"
                      />
                      <label htmlFor="subject" className="inp-field">
                        Subject
                      </label>
                    </div>
                  </div>
                  <div className="col-12">
                    <div className="form-floating">
                      <textarea
                        ...
                        required
                      ></textarea>
                      <label htmlFor="message  " className="inp-field">
